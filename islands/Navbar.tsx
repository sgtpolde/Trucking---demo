export function Navbar() {
  return (
    <nav class="bg-white shadow dark:bg-gray-900 z-50 fixed top-0 w-full max-md:hidden overflow-x-auto">
      <div class="flex items-center justify-center mr-2 p-6  text-gray-600 capitalize dark:text-gray-300">
        <a
          href="#"
